import type { ScenarioInputs, MonthlyProjection, ScenarioSummary } from "../types.ts";

export function calculateProjections(inputs: ScenarioInputs): MonthlyProjection[] {
  const {
    startingMRR,
    monthlyGrowthRate,
    monthlyChurnRate,
